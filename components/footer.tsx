        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#saas" className="text-gray-400 hover:text-primary">
                  SaaS Development
                </Link>
              </li>
              <li>
                <Link href="#landing" className="text-gray-400 hover:text-primary">
                  Landing Pages
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#ecommerce" className="text-gray-400 hover:text-primary">
                  E-Commerce
                </Link>
              </li>
            </ul>
